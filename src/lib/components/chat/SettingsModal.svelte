<script lang="ts">
    ...
    import {OLLAMA_API_BASE_URL, WEB_UI_VERSION} from '$lib/constants';
    import toast from 'svelte-french-toast';
    import {onMount} from 'svelte';
    import {config, models, settings, user} from '$lib/stores';
    import {getGravatarURL, splitStream} from '$lib/utils';
    ...
    const toggleUseOwnData = async () => {
        options.useOwnData = !options.useOwnData;
    };
    ...
    onMount(() => {
        ...
        options.useOwnData = settings.options?.useOwnData ?? '';
                            ...
                            <button
									...
									saveSettings({
										options: {
											...
											useOwnData: options.useOwnData === true ? options.useOwnData : undefined
										}
									});
									show = false;
								}}
                ...
                {:else if selectedTab === 'addons'}
                    ...
                    >
                        <div class=" space-y-3">
                            ...
                            <div>
                                <div class=" py-1 flex w-full justify-between">
                                    <div class=" self-center text-sm font-medium">Use my own input data</div>
                        ...
                        <div class=" space-y-3">
                            ...
                            {#if authEnabled}
                                ...
                                <div class="mt-2">
                                    ...
                                    >'Basic'</span
                                    >
                                        and <span class=" text-gray-500 dark:text-gray-300 font-medium">'Bearer'</span>
                                        by
